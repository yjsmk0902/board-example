...
import practice.board.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .csrf().disable()       //JWT 적용 (쿠키 기반 사용안함)
                //CORS 설정
                .cors(c -> {
                ...
                //Spring Security 세션 정책: 세션 생성 및 사용 안함
    ...
    @Bean   //Password 앞에 Encoding 방식이 붙은채 저장
